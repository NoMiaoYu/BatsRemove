...
public class BatRemoveMod implements ModInitializer {
    ...
    public void onInitialize() {
        // The whole 1.19 series (1.19.0 - 1.19.4) spawns bats from biome spawn lists
        // (AMBIENT group). Remove the bat entry from every biome so they no longer spawn
        // naturally. Player-spawned bats (/summon, spawn eggs) are unaffected.
        BiomeModifications.create(new Identifier(MOD_ID, "remove_bats"))
            .add(
